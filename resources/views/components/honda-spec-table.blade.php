...
<div class="space-y-6">
    {{-- 1. Paket Hemat Honda Perawatan Berkala Banner (Top of brochure) --}}
            ...
            <div class="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5 flex flex-col justify-between backdrop-blur-sm hover:border-red-500/40 transition">
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <x-icon name="check-badge" class="size-4 text-accent-400"/>
                    </div>
                    <div class="mt-2">
            ...
            <div class="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5 flex flex-col justify-between backdrop-blur-sm">
                <div>
                    ...
                    <ul class="space-y-2 text-xs text-slate-300">
                        <li class="flex items-start gap-2">
                            <x-icon name="check" class="size-3.5 text-red-400 shrink-0 mt-0.5"/>
                ...
                <div class="mt-3 border-t border-white/10 pt-2.5">
                    <p class="text-[10px] text-slate-400 flex items-center gap-1">
                        <x-icon name="shield" class="size-3 text-emerald-400"/>
    ...
    {{-- 2. Official Honda Specifications Table --}}
    <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        {{-- Section Title Bar (Honda Red Accent) --}}
        <div class="flex items-center justify-between bg-charcoal-900 px-6 py-4 text-white border-b-4 border-red-600">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400">{{ $brand }} {{ $model }} &bull; Model Year {{ $year }}</p>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="divide-y divide-slate-100 text-xs">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 p-3.5 hover:bg-slate-50 transition">
                        ...
                        <span class="sm:col-span-2 font-semibold text-slate-900">{{ $engineCapacity }}</span>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-3 p-3.5 hover:bg-slate-50 transition">
            ...
            <div>
                ...
                <div class="divide-y divide-slate-100 text-xs">
                    <div class="grid grid-cols-1 sm:grid-cols-3 p-3.5 hover:bg-slate-50 transition">
                        ...
                        <span class="sm:col-span-2 font-semibold text-slate-900">{{ $transmission }} with Earth Dreams Technology</span>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-3 p-3.5 hover:bg-slate-50 transition">
