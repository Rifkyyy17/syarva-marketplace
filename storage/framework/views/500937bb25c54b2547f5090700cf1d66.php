...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Kelola Kecamatan <?php $__env->endSlot(); ?>
     <?php $__env->slot('pageTitle', null, []); ?> Kelola Kecamatan <?php $__env->endSlot(); ?>

    <div class="grid gap-6 lg:grid-cols-[1fr_320px]">
        <div class="min-w-0 space-y-5">
            <form method="GET" action="<?php echo e(request()->url()); ?>" class="flex flex-wrap items-center gap-2">
...
<?php endif; ?>
                    <input type="search" name="q" value="<?php echo e(request('q')); ?>" placeholder="Cari kecamatan..." class="input w-48! pl-9! py-2! text-sm">
                </label>
                <select name="city_id" class="input w-auto! py-2! text-sm" aria-label="Filter kota">
                    <option value="">Semua Kota</option>
                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($city->id); ?>" <?php if((string) request('city_id') === (string) $city->id): echo 'selected'; endif; ?>><?php echo e($city->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <button type="submit" class="btn-outline btn-sm">Filter</button>
                <?php if(request()->hasAny(['q', 'city_id'])): ?>
                    <a href="<?php echo e(request()->url()); ?>" class="btn-ghost btn-sm">Reset</a>
                <?php endif; ?>
            </form>

            <?php if($districts->isNotEmpty()): ?>
                                    ...
                                    <tr x-data="{ editing: false }" class="hover:bg-slate-50/60">
                                        <td class="td">
                                            <template x-if="!editing">
                                                <p class="font-semibold text-slate-800"><?php echo e($district->name); ?></p>
                                            </template>
                                            <form x-show="editing" x-cloak method="POST" action="<?php echo e(route('admin.locations.districts.update', $district)); ?>" class="flex gap-2">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PUT'); ?>
                                                <div class="flex-1">
                                                    <input type="text" name="name" value="<?php echo e($district->name); ?>" required maxlength="100" class="input py-1!.5 text-sm">
                                                    <input type="hidden" name="slug" value="<?php echo e($district->slug); ?>">
                                                    <select name="city_id" class="input py-1!.5 text-sm">
                                                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($city->id); ?>" <?php if($district->city_id === $city->id): echo 'selected'; endif; ?>><?php echo e($city->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                <button type="submit" class="btn-primary btn-sm px-2!.5" aria-label="Simpan"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?></button>
                                        ...
                                        <td class="td hidden sm:table-cell"><?php echo e($district->city->name); ?></td>
                                        <td class="td hidden md:table-cell"><?php echo e($district->city->province->name); ?></td>
                                        <td class="td hidden lg:table-cell"><?php echo e($district->listings_count); ?></td>
...
<?php endif; ?> Edit
                                                    ...
                                                    <form method="POST" action="<?php echo e(route('admin.locations.districts.destroy', $district)); ?>" class="border-t border-slate-100">
                                                        <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'Kecamatan tidak ditemukan','message' => 'Tidak ada kecamatan yang cocok dengan filter.','icon' => 'map']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Kecamatan tidak ditemukan','message' => 'Tidak ada kecamatan yang cocok dengan filter.','icon' => 'map']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <aside class="lg:sticky lg:top-24 lg:self-start">
            <div class="card p-5">
                ...
                <form method="POST" action="<?php echo e(route('admin.locations.districts.store')); ?>" class="mt-4 space-y-3">
                    <?php echo csrf_field(); ?>
                    <div>
                        ...
                        <select id="city_id" name="city_id" required class="input py-2! text-sm">
                            <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($city->id); ?>" <?php if((string) old('city_id') === (string) $city->id): echo 'selected'; endif; ?>><?php echo e($city->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        <label for="name" class="label mb-1! text-xs">Nama Kecamatan</label>
                        <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" required maxlength="100" class="input py-2! text-sm <?php echo e($errors->has('name') ? 'input-error' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" name="slug" value="<?php echo e(old('slug')); ?>" required maxlength="100" class="input py-2! text-sm" placeholder="cth: coblong">
...
<?php endif; ?><?php /**PATH D:\SYARVA\resources\views\admin\locations\districts.blade.php ENDPATH**/ ?>