...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['icon' => 'tag', 'label', 'value']));
...
foreach (array_filter((['icon' => 'tag', 'label', 'value']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php endif; ?>
    ...
    <div class="min-w-0 flex-1">
        <dt class="text-[11px] font-bold uppercase tracking-wider text-slate-400"><?php echo e($label); ?></dt>
        <dd class="mt-0.5 truncate text-sm font-bold text-slate-900"><?php echo e($value ?? '-'); ?></dd>
    </div>
</div><?php /**PATH D:\SYARVA\resources\views\components\spec-item.blade.php ENDPATH**/ ?>