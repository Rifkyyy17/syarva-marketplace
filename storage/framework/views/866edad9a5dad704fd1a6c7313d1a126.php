...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Halaman Tidak Ditemukan <?php $__env->endSlot(); ?>
...
<?php endif; ?> Kembali ke Beranda
                ...
                <a href="<?php echo e(route('listings.index')); ?>" class="btn-outline">Jelajahi Listing</a>
            </div>
        </div>
    </div>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH D:\SYARVA\resources\views\errors\404.blade.php ENDPATH**/ ?>