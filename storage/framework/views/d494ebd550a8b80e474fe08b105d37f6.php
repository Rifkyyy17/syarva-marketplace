...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Kelola User <?php $__env->endSlot(); ?>
     <?php $__env->slot('pageTitle', null, []); ?> Kelola User <?php $__env->endSlot(); ?>
...
<?php endif; ?>
                <input type="search" name="q" value="<?php echo e(request('q')); ?>" placeholder="Cari nama, email, HP..." class="input w-56! pl-9! py-2! text-sm">
            </label>
            <select name="role" class="input w-auto! py-2! text-sm" aria-label="Filter role">
                ...
                <option value="user" <?php if(request('role') === 'user'): echo 'selected'; endif; ?>">Pembeli</option>
            </select>
            <select name="status" class="input w-auto! py-2! text-sm" aria-label="Filter status">
                ...
                <option value="suspended" <?php if(request('status') === 'suspended'): echo 'selected'; endif; ?>>Ditangguhkan</option>
            </select>
                                ...
                                <td class="td">
                                    <div class="flex items-center gap-3">
                                        <span class="grid size-10 shrink-0 place-items-center overflow-hidden rounded-full bg-primary-700 text-sm font-bold text-white">
                                            <?php if($user->avatar): ?>
                                                <img src="<?php echo e(Storage::disk('public')->url($user->avatar)); ?>" alt="" class="size-full object-cover">
                                            <?php else: ?>
                                        ...
                                        <div class="min-w-0">
                                            <p class="truncate text-sm font-semibold text-slate-800"><?php echo e($user->name); ?></p>
                                            <p class="truncate text-xs text-slate-400"><?php echo e($user->email); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="td hidden whitespace-nowrap md:table-cell"><?php echo e($user->phone ?? '-'); ?></td>
                                <td class="td"><?php if (isset($component)) { $__componentOriginal2ddbc40e602c342e508ac696e52f8719 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2ddbc40e602c342e508ac696e52f8719 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.badge','data' => ['status' => $user->role]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?></td>
                                <td class="td"><?php if (isset($component)) { $__componentOriginal2ddbc40e602c342e508ac696e52f8719 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2ddbc40e602c342e508ac696e52f8719 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.badge','data' => ['status' => $user->status]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php unset($__componentOriginal2ddbc40e602c342e508ac696e52f8719); ?>
<?php endif; ?></td>
                                <td class="td hidden whitespace-nowrap sm:table-cell"><?php echo e($user->listings_count); ?></td>
                                <td class="td hidden whitespace-nowrap lg:table-cell"><?php echo e($user->created_at->translatedFormat('d M Y')); ?></td>
...
<?php endif; ?>
                                        ...
                                        <div x-show="open" x-transition class="absolute right-0 z-20 mt-1 w-48 overflow-hidden rounded-xl border border-slate-200 bg-white py-1 text-left shadow-lg" x-cloak>
                                            <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="block px-4 py-2 text-sm text-slate-600 hover:bg-slate-50">
                                                <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?> Edit
                                            ...
                                            <?php if($user->id !== auth()->id()): ?>
                                                <form method="POST" action="<?php echo e(route('admin.users.toggle-status', $user)); ?>" class="border-t border-slate-100">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit" class="block w-full px-4 py-2 text-left text-sm <?php echo e($user->status === 'active' ? 'text-red-600 hover:bg-red-50' : 'text-emerald-700 hover:bg-emerald-50'); ?>">
                                                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => $user->status === 'active' ? 'ban' : 'check-circle','class' => 'mr-1.5 inline size-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user->status === 'active' ? 'ban' : 'check-circle'),'class' => 'mr-1.5 inline size-4']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?>
                                                        <?php echo e($user->status === 'active' ? 'Tangguhkan' : 'Aktifkan'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'User tidak ditemukan','message' => 'Tidak ada user yang cocok dengan filter Anda.','icon' => 'users']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'User tidak ditemukan','message' => 'Tidak ada user yang cocok dengan filter Anda.','icon' => 'users']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH D:\SYARVA\resources\views\admin\users\index.blade.php ENDPATH**/ ?>