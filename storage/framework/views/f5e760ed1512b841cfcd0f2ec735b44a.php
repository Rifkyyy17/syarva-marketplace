...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Kelola Provinsi <?php $__env->endSlot(); ?>
     <?php $__env->slot('pageTitle', null, []); ?> Kelola Provinsi <?php $__env->endSlot(); ?>
...
<?php endif; ?>
                    <input type="search" name="q" value="<?php echo e(request('q')); ?>" placeholder="Cari provinsi..." class="input w-56! pl-9! py-2! text-sm">
                </label>
                                    ...
                                    <tr x-data="{ editing: false }" class="hover:bg-slate-50/60">
                                        <td class="td">
                                            <template x-if="!editing">
                                                <p class="font-semibold text-slate-800"><?php echo e($province->name); ?></p>
                                            </template>
                                            <form x-show="editing" x-cloak method="POST" action="<?php echo e(route('admin.locations.provinces.update', $province)); ?>" class="flex gap-2">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PUT'); ?>
                                                <div class="flex-1">
                                                    <input type="text" name="name" value="<?php echo e($province->name); ?>" required maxlength="100" class="input py-1!.5 text-sm">
                                                    <input type="hidden" name="slug" value="<?php echo e($province->slug); ?>">
                                                </div>
...
<?php endif; ?></button>
                                        ...
                                        <td class="td hidden sm:table-cell"><?php echo e($province->cities_count); ?></td>
                                        <td class="td hidden md:table-cell"><?php echo e($province->listings_count); ?></td>
...
<?php endif; ?> Edit
                                                    ...
                                                    <form method="POST" action="<?php echo e(route('admin.locations.provinces.destroy', $province)); ?>" class="border-t border-slate-100">
                                                        <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'Provinsi tidak ditemukan','message' => 'Tidak ada provinsi yang cocok dengan pencarian.','icon' => 'map']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Provinsi tidak ditemukan','message' => 'Tidak ada provinsi yang cocok dengan pencarian.','icon' => 'map']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <aside class="lg:sticky lg:top-24 lg:self-start">
            <div class="card p-5">
                ...
                <form method="POST" action="<?php echo e(route('admin.locations.provinces.store')); ?>" class="mt-4 space-y-3">
                    <?php echo csrf_field(); ?>
                    <div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" name="slug" value="<?php echo e(old('slug')); ?>" required maxlength="100" class="input py-2! text-sm" placeholder="cth: jawa-barat">
...
<?php endif; ?><?php /**PATH D:\SYARVA\resources\views\admin\locations\provinces.blade.php ENDPATH**/ ?>