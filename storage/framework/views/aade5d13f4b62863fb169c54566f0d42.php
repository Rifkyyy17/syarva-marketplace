...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Terjadi Kesalahan <?php $__env->endSlot(); ?>
...
<?php endif; ?> Kembali ke Beranda
                ...
                <a href="<?php echo e(route('contact')); ?>" class="btn-outline">Hubungi Kami</a>
            </div>
        </div>
    </div>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH D:\SYARVA\resources\views\errors\500.blade.php ENDPATH**/ ?>