...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Kelola Kota/Kabupaten <?php $__env->endSlot(); ?>
     <?php $__env->slot('pageTitle', null, []); ?> Kelola Kota/Kabupaten <?php $__env->endSlot(); ?>
...
<?php endif; ?>
                    <input type="search" name="q" value="<?php echo e(request('q')); ?>" placeholder="Cari kota..." class="input w-48! pl-9! py-2! text-sm">
                </label>
                <select name="province_id" class="input w-auto! py-2! text-sm" aria-label="Filter provinsi">
                    <option value="">Semua Provinsi</option>
                    <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($province->id); ?>" <?php if((string) request('province_id') === (string) $province->id): echo 'selected'; endif; ?>><?php echo e($province->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <button type="submit" class="btn-outline btn-sm">Filter</button>
                <?php if(request()->hasAny(['q', 'province_id'])): ?>
                                    ...
                                    <tr x-data="{ editing: false }" class="hover:bg-slate-50/60">
                                        <td class="td">
                                            <template x-if="!editing">
                                                <p class="font-semibold text-slate-800"><?php echo e($city->name); ?></p>
                                            </template>
                                            <form x-show="editing" x-cloak method="POST" action="<?php echo e(route('admin.locations.cities.update', $city)); ?>" class="flex gap-2">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PUT'); ?>
                                                <div class="flex-1">
                                                    <input type="text" name="name" value="<?php echo e($city->name); ?>" required maxlength="100" class="input py-1!.5 text-sm">
                                                    <input type="hidden" name="slug" value="<?php echo e($city->slug); ?>">
                                                    <select name="province_id" class="input py-1!.5 text-sm">
                                                        <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($province->id); ?>" <?php if($city->province_id === $province->id): echo 'selected'; endif; ?>><?php echo e($province->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
...
<?php endif; ?></button>
                                        ...
                                        <td class="td hidden sm:table-cell"><?php echo e($city->province->name); ?></td>
                                        <td class="td hidden md:table-cell"><?php echo e($city->districts_count); ?></td>
                                        <td class="td hidden lg:table-cell"><?php echo e($city->listings_count); ?></td>
...
<?php endif; ?> Edit
                                                    ...
                                                    <form method="POST" action="<?php echo e(route('admin.locations.cities.destroy', $city)); ?>" class="border-t border-slate-100">
                                                        <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'Kota tidak ditemukan','message' => 'Tidak ada kota yang cocok dengan filter.','icon' => 'building']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Kota tidak ditemukan','message' => 'Tidak ada kota yang cocok dengan filter.','icon' => 'building']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <aside class="lg:sticky lg:top-24 lg:self-start">
            <div class="card p-5">
                ...
                <form method="POST" action="<?php echo e(route('admin.locations.cities.store')); ?>" class="mt-4 space-y-3">
                    <?php echo csrf_field(); ?>
                    <div>
                        ...
                        <select id="province_id" name="province_id" required class="input py-2! text-sm">
                            <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($province->id); ?>" <?php if((string) old('province_id') === (string) $province->id): echo 'selected'; endif; ?>><?php echo e($province->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" name="slug" value="<?php echo e(old('slug')); ?>" required maxlength="100" class="input py-2! text-sm" placeholder="cth: bandung">
...
<?php endif; ?><?php /**PATH D:\SYARVA\resources\views\admin\locations\cities.blade.php ENDPATH**/ ?>